...
export default function UserOrderDetailPage() {
  ...
  const handleRiderRateSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("Thank you! Your delivery partner review has been recorded.");
    } catch (err: any) {
  ...
  const deliveryOtp = order.deliveryOtp || (tracking as any)?.deliveryOtp;
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="space-y-1">
              ...
              <p className="text-xs text-foreground font-medium max-w-xl">
                Your delivery partner is at your destination. Provide this 6-digit OTP code to the rider to confirm receiving your package safely.
              </p>
            </div>
