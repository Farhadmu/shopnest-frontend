  ...
  return (
    <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
      <Link
        ...
        title="Wishlist"
        className="relative grid h-8 w-8 sm:h-9 sm:w-9 shrink-0 place-items-center rounded-full border border-white/20 bg-white/10 text-white transition hover:bg-white/20 active:scale-95"
      >
      ...
      <motion.button
        ...
        title="Shopping Cart"
        className="relative hidden md:grid h-9 w-9 shrink-0 place-items-center rounded-full border border-white/20 bg-white/10 text-white transition hover:bg-white/20 cursor-pointer active:scale-95"
      >
      ...
      {/* Profile & auth dropdown - hidden on mobile screens, horizontally flexed on tablet/desktop */}
