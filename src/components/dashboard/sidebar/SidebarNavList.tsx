        ...
        {links.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              onClick={onNavigate}
              className={`group relative flex items-center justify-between gap-3 rounded-xl px-3 py-2.5 text-xs font-bold transition-all duration-200 ${
                isActive
            ...
            {grp.items.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  onClick={onNavigate}
                  className={`group relative flex items-center justify-between gap-2.5 rounded-xl px-3 py-2 text-xs font-bold transition-all duration-200 ${
                    isActive
